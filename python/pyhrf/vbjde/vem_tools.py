...
def labels_expectation_asl(nrls_covar, nrls_mean, nrls_class_var, nrls_class_mean, prls_covar, prls_mean, prls_class_var, prls_class_mean,
                       beta, labels_proba, neighbours_indexes, nb_conditions,
                       nb_classes, nb_voxels=None, parallel=True, nans_init=False):
    """Computes the E-Z (or E-Q) step of the JDE-VEM algorithm for ASL.
